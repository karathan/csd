...
public class Cars {
    ...
    public static void main(String args[]) {
        ...
        Comparator<Car> byTopSpeed = (c1, c2) -> Double.compare(c2.getTopSpeed(),
                c1.getTopSpeed());

        list.stream().filter(s -> "Germany".equals(s.getCountry())).sorted(byTopSpeed).limit(2).forEach(s -> System.out.println(s));
    }
